...
namespace rpg {
	...
	public:
		enum class Code {
			...
			increase_transp = 40,
			decrease_transp = 41,
			EasyRpg_SetFixedGraphic = 200,
			EasyRpg_IncrementFixedGraphic_i = 201,
			EasyRpg_DecrementFixedGraphic_i = 202,
			EasyRpg_IncrementFixedGraphic_x = 203,
			EasyRpg_IncrementFixedGraphic_y = 204,
			EasyRpg_DecrementFixedGraphic_x = 205,
			EasyRpg_DecrementFixedGraphic_y = 206,
			EasyRpg_CloneEventGraphic = 207,
			EasyRpg_CloneActorGraphic = 208,
			EasyRpg_CloneVehicleGraphic = 209,
			EasyRpg_ClearGraphic = 210,
			EasyRpg_RevertGraphic = 211,
			EasyRpg_WaitFrame = 212,
			EasyRpg_SetupEasing = 213,
			EasyRpg_WaitFrameEasing = 214
		};
		static constexpr auto kCodeTags = lcf::EnumTags{
			...
			Code::EasyRpg_CloneVehicleGraphic, "EasyRpg_CloneVehicleGraphic",
			...
			Code::EasyRpg_SetupEasing, "EasyRpg_SetupEasing",
			Code::EasyRpg_WaitFrameEasing, "EasyRpg_WaitFrameEasing"
		};
