...
namespace rpg {
	...
	public:
		enum class Code {
			...
			EasyRpg_CloneEventGraphic = 210,
			EasyRpg_CloneActorGraphic = 211,
			EasyRpg_ClearGraphic = 212,
			EasyRpg_RevertGraphic = 213,
			EasyRpg_SetFixedGraphic = 214,
			EasyRpg_IncrementFixedGraphic_i = 215,
			EasyRpg_DecrementFixedGraphic_i = 216,
			EasyRpg_IncrementFixedGraphic_x = 217,
			EasyRpg_IncrementFixedGraphic_y = 218,
			EasyRpg_DecrementFixedGraphic_x = 219,
			EasyRpg_DecrementFixedGraphic_y = 220
		};
